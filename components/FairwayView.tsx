...
export function FairwayView({ shots, clubs, highlightShot }: Props) {
  ...
  return (
    <svg viewBox={`0 0 ${SVG_W} ${SVG_H}`} className="w-full rounded-xl overflow-hidden">
          ...
          return (
            <g key={yd}>
              <line
                ...
                strokeDasharray="4,4"
              />
              <text x={6} y={y - 3} fontSize={9} fill="white" fillOpacity={0.7} fontWeight="600">
                {yd} yd
              </text>
            </g>
          );
