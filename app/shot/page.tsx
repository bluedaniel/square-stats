...
function fmtImpact(n: number): string {
  ...
  return `${n > 0 ? "Toe" : "Heel"} ${Math.abs(n).toFixed(1)}`;
}
  ...
  return [
    ...
    },
    {
      ...
      stats: [
        ...
        { label: "Club Speed",   value: shot.clubSpeed ? fmt(shot.clubSpeed, 1, "mph") : "—" },
        { label: "Smash Factor", value: shot.smashFactor ? fmt(shot.smashFactor, 2) : "—" },
      ],
    },
    {
      title: "Launch",
      ...
      stats: [
        ...
        { label: "Launch Direction", value: fmtDir(shot.launchDirection) + "°" },
    ...
    },
    {
      ...
      cols: 4 as const,
      stats: [
        { label: "Spin Rate",  value: shot.spinRate ? fmt(shot.spinRate, 0, "rpm") : "—" },
    ...
    return (
      <div className="flex items-center justify-center min-h-screen">
        <div className="text-center space-y-3">
          ...
          <Link href="/shots" className="text-sm underline">Back to shots</Link>
        </div>
      </div>
    );
  }
    ...
    <div className="min-h-screen bg-background text-foreground">
      <header className="border-b px-6 py-4 flex items-center justify-between gap-4">
        <div className="flex items-center gap-4">
          <Link href="/shots" className="text-muted-foreground hover:text-foreground text-sm">
            ← All shots
          </Link>
          <div>
            <div className="flex items-center gap-2">
              <h1 className="text-xl font-bold">{shot.club} · Shot #{shot.index}</h1>
